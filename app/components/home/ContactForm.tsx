...
import { submitContactForm, getServices } from "@/app/actions/actions";
    ...
    const fetchServices = async () => {
      try {
        ...
        if (result.success && result.data) {
          // Set services directly from the data array
                      ...
                      {services.length > 0 ? (
                        services.map((service) => (
                          <div key={service._id} className="flex items-center">
                            ...
                            />
                            <label htmlFor={service._id} className="ml-2 text-sm font-medium text-gray-700">
