          ...
          >
            ...
            <div className="mt-auto space-y-6">
              <div className="flex items-center gap-3">
                ...
                <a
                  ...
                  className="hover:underline transition-colors hover:text-purple-300"
                  title={t("callUs")}
                >
                  {settings.phone}
                </a>
            ...
            <div className="flex gap-4 mt-10">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="rounded-full bg-white/10 p-2 hover:bg-purple-600 transition-colors"
                title={t("followOnTwitter")}
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
